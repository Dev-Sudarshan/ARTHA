...
def get_all_items_batch(*tables: str) -> Dict[str, Dict[str, Any]]:
    """Compatibility helper for admin routes that fetch several tables at once."""
    result: Dict[str, Dict[str, Any]] = {}
    for table in tables:
        result[table] = get_all_items(table)
    return result
